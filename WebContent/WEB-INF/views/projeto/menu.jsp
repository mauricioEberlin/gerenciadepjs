...
<div class="main-content">
	...
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			...
			<button type="button" name="quantidade" class="btn btn-primary pro"
			...
			<div class="row">
				...
				<c:forEach items="${projetos}" var="projeto" begin="${priProjeto}"
					end="${ultProjeto}">
					<div id="lista" class="col-md-4">
						<div class="card card-projetos border border-primary">
							<div class="card-header">
								<strong class="card-title">#${projeto.id} -
									${projeto.nome}</strong>
							</div>
							<div class="card-body">
								<p class="card-text">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="${urlEditar}?id=${projeto.id}"><button type="button"
